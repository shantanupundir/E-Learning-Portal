...
const TeachersForm: React.FC<TeachersFormProps> = ({ onLogin, onForgotPassword }) => {
  ...
  return (
    <div className="bg-[#000319] p-6 rounded-lg shadow-lg w-full max-w-md mx-auto">
      <h1 className="text-2xl font-bold text-white mb-6 text-center">Login as Mentor</h1>
      <div className="mb-4">
      ...
      <button
        ...
        className="w-full bg-blue-600 text-white p-3 rounded-lg shadow-lg hover:bg-blue-700 transition-colors duration-300"
      >
        Login as Mentor
      </button>
